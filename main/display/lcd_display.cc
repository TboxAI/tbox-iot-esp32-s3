...
#define LIGHT_BACKGROUND_COLOR       lv_color_hex(0x060C1A)     // dark blue background
#define LIGHT_TEXT_COLOR             lv_color_hex(0xdcf6fe)     // 0xdcf6fe text
...
#define LIGHT_LOW_BATTERY_COLOR      lv_color_hex(0xFC0000)     // Red for light mode
