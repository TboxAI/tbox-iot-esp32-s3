...
extern "C" {
    esp_netif_t * s_wifi_sta_netif = NULL;
}
...
WifiStation::WifiStation():s_sta_netif_(NULL) {
...
void WifiStation::Stop() {
    ...
    if (s_sta_netif_ != nullptr) {
        esp_netif_destroy_default_wifi(s_sta_netif_);
        s_sta_netif_ = nullptr;
    }
